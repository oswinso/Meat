...
import MeatButton from './button/MeatButton'
...
const MeetingDetailsPage = () => {
  const {
    ...
    endTime, setEndTime,
    newMeeting, postNewMeeting
  } = MeetingDetailsStore.useContainer()
  ...
  return (
    <div className="meeting-details-container">
      ...
      <div className="form-group">
        <TextArea placeholder="What's your meat about?" text={description} setText={setDescription}
                  attributes={{ rows: 5 }}/>
      </div>
      <div className="form-group">
      ...
      {newMeeting && newMeeting.data !== null && newMeeting.complete && !newMeeting.error &&
      <Redirect push to={getMeetingUrl()}/>}
    </div>
  )
}
